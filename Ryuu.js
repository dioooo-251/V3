...
│✾ ${prefix}asupanmenu ‍[️💅] 
│✾ ${prefix}nulismenu ‍[📝️]
│✾ ${prefix}downloadmenu ‍[🗃️]
│✾ ${prefix}convertmenu ‍[💾️]
│✾ ${prefix}animemenu [⛩️‍]
│✾ ${prefix}owner [🧸]
│✾ ${prefix}sc [💻] 
│✾ ${prefix}tqto [🏆] 
...
"title": "[🧸] Creator",
"rowId": `${prefix}owner`, 
"description": `Pembuat ${botname}`
},
{
"title": "[💻] Source Code",
"rowId": `${prefix}sc`, 
"description": `Menampilkan Script ${botname}`
},
{
"title": "[🏆] Big Thanks To",
"rowId": `${prefix}tqto`, 
...
"title": "[📚] Rules",
"rowId": `${prefix}rules`, 
"description": `Menampilkan Rules Pengguna ${botname}`
}
]
}],
listType: 1
...
reqXp  = 5000 * (Math.pow(2, getLevelingLevel(sender)) - 1)
var p = await Ryuu.getStatus(`${sender}`, MessageType.text)
ptod = "6285752052085@s.whatsapp.net"
stod = `${sender}`
dtod = 'ngetes'
uwu = '```'
